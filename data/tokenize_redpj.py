...
class TokenizeConfig:
    ...
    load_dataset_path: Optional[str] = field(default='datasets/togethercomputer___red_pajama-data-1_t-sample')
    ...
    def __post_init__(self):
        if self.load_dataset_path == 'togethercomputer/RedPajama-Data-1T':
            self.text_key = 'text'
        elif self.load_dataset_path == 'datasets/togethercomputer___red_pajama-data-1_t-sample':
            self.text_key = 'text'
        else:
...
def tokenize_and_save(tokenizer: AutoTokenizer, config: TokenizeConfig):
    ...
    """
    print(config.tokenizer_model_name)
